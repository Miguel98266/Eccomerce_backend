...
Select first_name from customer WHERE email='angeles@gmail.com';

select first_name,last_name,TO_CHAR(birth, 'DD-MM-YYYY') as birth ,gender,rol_name from customer 
